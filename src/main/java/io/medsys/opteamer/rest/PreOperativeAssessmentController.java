...
import io.medsys.opteamer.service.PreOperativeAssessmentService;
...
public class PreOperativeAssessmentController {
    ...
    public ResponseEntity<PreOperativeAssessmentDTO> getPreOperativeAssessmentById(@PathVariable(name = "name") String name) {
        Optional<PreOperativeAssessmentDTO> preOperativeAssessmentOptional = preOperativeAssessmentService.getPreOperativeAssessmentById(name);
    ...
    public ResponseEntity<PreOperativeAssessmentDTO> updatePreOperativeAssessment(
            @PathVariable(name = "name") String name, @RequestBody PreOperativeAssessmentDTO preOperativeAssessmentDTO) {
        Optional<PreOperativeAssessmentDTO> preOperativeAssessmentDTOOptional =
